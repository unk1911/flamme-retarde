...
# written and `scp` would have deleted 131 lines nobody has a copy of.
...
> ### ⚠ STOP. mpcn0's `baye.py` was ahead of the repository when this was written.
>
> On 4 Sep 2026, `mpcn0:~/baye/baye.py` was **883 lines** and `server/baye/baye.py`
> at 1.235.0 was **752**. Those 131 lines are in no branch of this repository —
> they were deployed from an uncommitted tree or edited on the box. **`scp`-ing
> over that file would silently delete them**, which is the same class of mistake
> as the one this whole release is about: authority in a place that can be
> overwritten.
>
