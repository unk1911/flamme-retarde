...
const STRINGS = {
  ...
  en: {
    ...
    'help.k.ears': 'microphone: talk to them — ENTER types instead',
  ...
  hr: {
    ...
    'help.k.ears': 'mikrofon: pričaj s njima — ENTER za tipkanje',
  ...
  fr: {
    ...
    'help.k.ears': 'micro : leur parler — ENTRÉE pour écrire',
