...
const STRINGS = {
  ...
  en: {
    ...
    'toast.cheatKab': 'inside the kabina — the doorway is behind you',
    ...
    'body.onTouch': 'Round behind you. Stand still and it walks round you. <b>BODY</b> again to get back in your own eyes.',
    ...
    'set.off': 'off',
    'help.title': 'controls',
    'help.open': 'controls & keys',
    'auth.signin': 'sign in',
    'auth.badge': 'signed in',
    'auth.title': 'sign in',
    'auth.blurb': "One sign-in, for the laptop at Jadrija and for Baye's voice.",
    'auth.user': 'user',
    'auth.pass': 'password',
    'auth.go': 'sign in',
    'auth.out': 'sign out',
    'auth.as': 'signed in as {u}',
    'auth.bad': 'rejected — check the user and the password',
    'auth.rate': 'too many attempts — wait a few minutes; the password may well be right',
    ...
    'auth.working': 'authenticating…',
    'auth.hello': 'signed in as {u} — Baye has her voice',
    'auth.bye': 'signed out',
    'auth.offOrigin': 'no line out of here — the sign-in only works on the deployed site',
    'voice.on': "Baye's voice on",
    'voice.off': "Baye's voice off",
    'ears.on': 'Listening — talk to them',
    'ears.off': 'Microphone off',
    'ears.type': 'type a command, Enter to send',
    'ears.signin': 'Sign in to talk to them',
    'ears.denied': 'No microphone — Chrome said no',
    'ears.nohost': 'she only hears you on the site, not off a local file',
    'voice.open': "Baye's voice",
    'help.k.voice': "Baye's voice on/off",
    'help.k.ears': 'type to them (the typing line)',
    ...
    'beer.done': 'empty',
    'help.k.lick': 'a lick of the ice cream',
    'help.k.bag': 'the satchel — what you are carrying',
    'help.k.cell': 'your phone — quotes, the Lovense, her on camera',
    'cream.got': 'an ice cream in your hand — ; to lick it',
    'cream.none': 'no ice cream on you',
    'help.k.ball': 'the beach ball — throw it for the Slow Doodle, or pick it up',
    'ball.away': 'the ball is over there — go and get it',
    'ball.picked': 'the ball is back in the satchel',
    'ball.foot': 'on foot, on the beach',
    'cream.done': 'all gone',
    'cream.melted': 'it has run — a wet cone and nothing on it',
    'help.k.menu': 'what else they have',
    // The satchel — src/62-satchel.js. The head is the word Misha used for it.
    'satchel.head': 'satchel',
    'satchel.empty': 'nothing on you',
    'help.k.satchel': 'what you are carrying',
    'help.note': 'ESC or ? closes this.',
    'help.noteTouch': 'tap outside to close · the on-screen buttons do the same jobs',
    'help.g.fly': 'in the aeroplane',
    'help.g.foot': 'on foot',
    'help.g.water': 'in the water',
    'help.g.doors': 'getting somewhere',
    'help.g.any': 'anywhere',
    'help.k.stick': 'fly her',
    'help.k.thr': 'throttle',
    'help.k.rudder': 'rudder',
    'help.k.scoop': 'scoop — held, not tapped',
    'help.k.drop': 'drop — held, not tapped',
    'help.k.level': 'level the wings',
    'help.k.ap': 'autopilot',
    'help.k.cam': 'cycle the camera',
    'help.k.gear': 'gear',
    'help.k.centre': 'centre the stick',
    'help.k.walk': 'walk',
    'help.k.run': 'run',
    'help.k.crouch': 'crouch — on your knees, and again to stand',
    'help.k.branch': 'the branch',
    'help.k.hop': 'jump — anywhere; a balcony, a trampoline',
    'help.k.lens': 'a longer look — held',
    'help.k.body': 'round behind you, and back',
    'help.k.up': 'up and clear of where you are stuck',
    'help.k.kite': 'take a kite out',
    'help.k.foil': 'take a foil out',
    'help.k.in': 'climb back in',
    'help.k.pc': 'sit at the laptop',
    'help.k.swim': 'swim',
    'help.k.kick': 'a burst',
    'help.k.rise': 'up',
    'help.k.dive': 'down',
    'help.k.auto': 'swim it for me',
    'help.k.ashore': 'go ashore',
    'help.k.bail': 'bail out — there is no way back',
    'help.k.jadrija': 'Jadrija',
    'help.k.kabina': 'inside the kabina',
    'help.k.rokici': 'Rokići',
  ...
  hr: {
    ...
    'veil.eyebrow': 'Šibenik · Dalmacija',
    ...
    'toast.cheatKab': 'u kabini — vrata su ti iza leđa',
    ...
    'body.onTouch': 'Kamera iza tebe. Stani i obići će te. Ponovno <b>TIJELO</b> za povratak u prvo lice.',
    ...
    'set.off': 'isključeno',
    'help.title': 'kontrole',
    'help.open': 'kontrole i tipke',
    'auth.signin': 'prijava',
    'auth.badge': 'prijavljen',
    'auth.title': 'prijava',
    'auth.blurb': 'Jedna prijava, za laptop u Jadriji i za Bayein glas.',
    'auth.user': 'korisnik',
    'auth.pass': 'lozinka',
    'auth.go': 'prijavi se',
    'auth.out': 'odjava',
    'auth.as': 'prijavljen kao {u}',
    'auth.bad': 'odbijeno — provjeri korisnika i lozinku',
    'auth.rate': 'previše pokušaja — pričekaj koju minutu; lozinka je možda ispravna',
    'auth.half': 'lozinka je dobra — ali sesija nije prihvaćena (SESSION_SECRET se ne podudara)',
    'auth.working': 'prijavljivanje…',
    'auth.hello': 'prijavljen kao {u} — Baye je dobila glas',
    'auth.bye': 'odjavljen',
    'auth.offOrigin': 'nema veze odavde — prijava radi samo na objavljenoj stranici',
    'voice.on': 'Bayein glas uključen',
    'voice.off': 'Bayein glas isključen',
    'ears.on': 'Slušam — pričaj s njima',
    'ears.off': 'Mikrofon isključen',
    'ears.type': 'upiši naredbu, Enter za poslati',
    'ears.signin': 'Prijavi se da bi pričao s njima',
    'ears.denied': 'Nema mikrofona — Chrome je odbio',
    'ears.nohost': 'čuje te samo na stranici, ne iz lokalne datoteke',
    'voice.open': 'Bayein glas',
    'help.k.voice': 'Bayein glas uključi/isključi',
    'help.k.ears': 'tipkaj im (redak za tipkanje)',
    ...
    'beer.done': 'prazno',
    'help.k.lick': 'liznuti sladoled',
    'help.k.bag': 'torba — što nosiš sa sobom',
    'help.k.cell': 'mobitel — tečajevi, Lovense, ona na kameri',
    'cream.got': 'sladoled u ruci — ; za lizanje',
    'cream.none': 'nemaš sladoled',
    'help.k.ball': 'lopta — baci je Sporom Doodleu, ili je podigni',
    'ball.away': 'lopta je tamo — idi po nju',
    'ball.picked': 'lopta je opet u torbi',
    'ball.foot': 'pješice, na plaži',
    'cream.done': 'nema više',
    'cream.melted': 'rastopio se — ostao je samo mokri kornet',
    'help.k.menu': 'što još imaju',
    'satchel.head': 'torbica',
    'satchel.empty': 'nemaš ništa',
    'help.k.satchel': 'što nosiš',
    'help.note': 'ESC ili ? zatvara.',
    'help.noteTouch': 'dodirni izvan okvira za zatvaranje · gumbi na ekranu rade isto',
    'help.g.fly': 'u zrakoplovu',
    'help.g.foot': 'pješice',
    'help.g.water': 'u vodi',
    'help.g.doors': 'prečaci',
    'help.g.any': 'bilo gdje',
    'help.k.stick': 'upravljanje',
    'help.k.thr': 'gas',
    'help.k.rudder': 'kormilo',
    'help.k.scoop': 'zahvat — drži se',
    'help.k.drop': 'izbacivanje — drži se',
    'help.k.level': 'poravnaj krila',
    'help.k.ap': 'autopilot',
    'help.k.cam': 'promijeni kameru',
    'help.k.gear': 'stajni trap',
    'help.k.centre': 'centriraj palicu',
    'help.k.walk': 'hodanje',
    'help.k.run': 'trčanje',
    'help.k.crouch': 'čučanj — na koljena, opet za ustati',
    'help.k.branch': 'grana',
    'help.k.hop': 'skok — bilo gdje; balkon, trampolin',
    'help.k.lens': 'bolji pogled — drži se',
    'help.k.body': 'kamera iza tebe, i natrag',
    'help.k.up': 'gore i van ako si zaglavio',
    'help.k.kite': 'uzmi zmaja',
    'help.k.foil': 'uzmi foil',
    'help.k.in': 'natrag unutra',
    'help.k.pc': 'sjedni za laptop',
    'help.k.swim': 'plivanje',
    'help.k.kick': 'zamah',
    'help.k.rise': 'gore',
    'help.k.dive': 'dolje',
    'help.k.auto': 'plivaj umjesto mene',
    'help.k.ashore': 'izađi na obalu',
    'help.k.bail': 'iskakanje — nema natrag',
    'help.k.jadrija': 'Jadrija',
    'help.k.kabina': 'u kabini',
    'help.k.rokici': 'Rokići',
  ...
  fr: {
    ...
    'toast.cheatKab': 'dans la kabina — la porte est derrière vous',
    ...
    'body.onTouch': 'Vue de dos. Reste immobile et elle tourne autour de toi. <b>CORPS</b> à nouveau pour revenir dans tes yeux.',
    ...
    'help.open': 'commandes et touches',
    'auth.signin': 'connexion',
    'auth.badge': 'connecté',
    'auth.title': 'connexion',
    'auth.blurb': 'Une seule connexion, pour le portable à Jadrija et pour la voix de Baye.',
    'auth.user': 'utilisateur',
    'auth.pass': 'mot de passe',
    'auth.go': 'se connecter',
    'auth.out': 'se déconnecter',
    'auth.as': 'connecté en tant que {u}',
    'auth.bad': "refusé — vérifiez l'identifiant et le mot de passe",
    'auth.rate': 'trop de tentatives — attendez quelques minutes ; le mot de passe est peut-être bon',
    'auth.half': "mot de passe correct — mais la session est refusée (SESSION_SECRET différent)",
    'auth.working': 'authentification…',
    'auth.hello': 'connecté en tant que {u} — Baye a retrouvé sa voix',
    'auth.bye': 'déconnecté',
    'auth.offOrigin': "aucune ligne d'ici — la connexion ne marche que sur le site déployé",
    'voice.on': 'voix de Baye activée',
    'voice.off': 'voix de Baye coupée',
    'ears.on': 'À l’écoute — parlez-leur',
    'ears.off': 'Micro coupé',
    'ears.type': 'tapez une commande, Entrée pour envoyer',
    'ears.signin': 'Connectez-vous pour leur parler',
    'ears.denied': 'Pas de micro — Chrome a refusé',
    'ears.nohost': 'elle ne vous entend que sur le site, pas en fichier local',
    'voice.open': 'voix de Baye',
    'help.k.voice': 'voix de Baye',
    'help.k.ears': 'écrivez-leur (la ligne de saisie)',
    ...
    'beer.done': 'vide',
    'help.k.lick': 'un coup de langue sur la glace',
    'help.k.bag': 'la sacoche — ce que vous portez',
    'help.k.cell': 'votre téléphone — les cours, le Lovense, elle en direct',
    'cream.got': 'une glace dans la main — ; pour la lécher',
    'cream.none': 'pas de glace sur vous',
    'help.k.ball': 'le ballon — lancez-le au Slow Doodle, ou ramassez-le',
    'ball.away': 'le ballon est là-bas — allez le chercher',
    'ball.picked': 'le ballon est de retour dans la sacoche',
    'ball.foot': 'à pied, sur la plage',
    'cream.done': 'tout mangé',
    'cream.melted': 'elle a coulé — un cornet mouillé et plus rien dessus',
    'help.k.menu': 'ce qu\'ils ont d\'autre',
    'satchel.head': 'sacoche',
    'satchel.empty': 'rien sur vous',
    'help.k.satchel': 'ce que vous portez',
    'help.note': 'ÉCHAP ou ? ferme.',
    'help.noteTouch': "toucher à côté pour fermer · les boutons à l'écran font la même chose",
    'help.g.fly': "dans l'avion",
    'help.g.foot': 'à pied',
    'help.g.water': "dans l'eau",
    'help.g.doors': 'raccourcis',
    'help.g.any': "n'importe où",
    'help.k.stick': 'piloter',
    'help.k.thr': 'gaz',
    'help.k.rudder': 'palonnier',
    'help.k.scoop': 'écoper — maintenir',
    'help.k.drop': 'larguer — maintenir',
    'help.k.level': 'remettre à plat',
    'help.k.ap': 'pilote automatique',
    'help.k.cam': 'changer de caméra',
    'help.k.gear': 'train',
    'help.k.centre': 'recentrer le manche',
    'help.k.walk': 'marcher',
    'help.k.run': 'courir',
    'help.k.crouch': "s'accroupir — à genoux, encore pour se lever",
    'help.k.branch': 'la branche',
    'help.k.hop': 'sauter — n’importe où ; balcon, trampoline',
    'help.k.lens': 'regarder de plus près — maintenir',
    'help.k.body': 'vue de dos, et retour',
    'help.k.up': 'se dégager si tu es coincé',
    'help.k.kite': 'prendre une aile',
    'help.k.foil': 'prendre un foil',
    'help.k.in': 'remonter à bord',
    'help.k.pc': "s'asseoir au portable",
    'help.k.swim': 'nager',
    'help.k.kick': 'une impulsion',
    'help.k.rise': 'monter',
    'help.k.dive': 'descendre',
    'help.k.auto': 'nage à ma place',
    'help.k.ashore': "sortir de l'eau",
    'help.k.bail': "s'éjecter — sans retour",
    'help.k.jadrija': 'Jadrija',
    'help.k.kabina': 'dans la kabina',
    'help.k.rokici': 'Rokići',
