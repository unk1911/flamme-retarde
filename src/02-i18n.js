...
const STRINGS = {
  ...
  en: {
    ...
    // ── the boat to Šibenik ──────────────────────────────────────────────
    // The callouts are what somebody standing next to you would say, and they
    ...
    'brod.board': '<b>E</b> to board the boat for Šibenik',
    'brod.boardTouch': 'tap to board the boat for Šibenik',
    'brod.arrived': 'Šibenik. She is alongside — mind the step.',
    'brod.callAway': 'let go aft · Jadrija astern',
    'brod.callLight': 'Rt Jadrija light, to port',
    'brod.callNikola': 'Tvrđava sv. Nikole, to starboard',
    'brod.callChannel': 'Kanal svetog Ante',
    'brod.callNarrows': 'the narrows · karst both sides',
    'brod.callSpilja': 'špilja sv. Ante, in the cliff to port',
    'brod.callTown': 'Šibenik · sv. Mihovil on the crag',
    'brod.callBerth': 'coming alongside',
    'toast.onTheBoat': 'Aboard. She goes when she goes; there is nothing to do but look.',
    'toast.overTheSide': 'Over the side. She is not coming back for you.',
    'toast.ashoreSibenik': 'Ashore at Šibenik, under the cathedral.',
    'toast.noQuay': 'No quay to step on to here.',
    'swim.depth': 'm down',
    'swim.breath': 'breath',
    ...
    'body.on': 'Round behind you. Stand still and it walks round you. <b>B</b> to get back in your own eyes.',
    'body.off': 'Back behind your eyes.',
    'chg.changed': 'Changed. <b>B</b> to have a look.',
    'chg.dressed': 'Dressed again.',
    ...
    'clip.rec': 'rec',
    'clip.rec.full': 'full',
    'clip.keep': 'L keeps it',
    'clip.on': 'Recording. L stops and keeps it.',
    'clip.saved': 'Kept %s seconds · %m MB, in your downloads.',
    'clip.empty': 'Nothing recorded — give it a second next time.',
    'clip.cannot': 'This browser will not record the canvas.',
    'clip.full': 'Stopped at %s minutes. L still keeps what you have.',
  ...
  hr: {
    ...
    'toast.tramp': 'slobodna kao ptica',
    ...
    'brod.board': '<b>E</b> za ukrcaj na brod za Šibenik',
    'brod.boardTouch': 'dodirni za ukrcaj na brod za Šibenik',
    'brod.arrived': 'Šibenik. Privezan je — pazi na korak.',
    'brod.callAway': 'otpuštaj krmu · Jadrija za krmom',
    'brod.callLight': 'svjetionik Rt Jadrija, lijevo',
    'brod.callNikola': 'Tvrđava sv. Nikole, desno',
    'brod.callChannel': 'Kanal svetog Ante',
    'brod.callNarrows': 'tjesnac · krš s obje strane',
    'brod.callSpilja': 'špilja sv. Ante, u stijeni lijevo',
    'brod.callTown': 'Šibenik · sv. Mihovil na hridi',
    'brod.callBerth': 'pristajemo',
    'toast.onTheBoat': 'Na brodu. Kreće kad kreće; nema se što raditi osim gledati.',
    'toast.overTheSide': 'Preko boka. Neće se vratiti po tebe.',
    'toast.ashoreSibenik': 'Na obali u Šibeniku, pod katedralom.',
    'toast.noQuay': 'Ovdje nema obale za iskrcaj.',
    'swim.depth': 'm dubine',
    'swim.breath': 'dah',
    ...
    'body.on': 'Kamera iza tebe. Stani i obići će te. <b>B</b> za povratak u prvo lice.',
    'body.off': 'Natrag u prvo lice.',
    'chg.changed': 'Presvučena. <b>B</b> za pogled.',
    'chg.dressed': 'Ponovno obučena.',
    ...
    'clip.rec.full': 'puno',
    'clip.keep': 'L sprema',
    'clip.on': 'Snima. L staje i sprema.',
    'clip.saved': 'Spremljeno %s s · %m MB, u preuzimanjima.',
    'clip.empty': 'Ništa nije snimljeno — daj mu sekundu idući put.',
    'clip.cannot': 'Ovaj preglednik ne snima platno.',
    'clip.full': 'Stalo na %s minuta. L i dalje sprema snimljeno.',
  ...
  fr: {
    ...
    'brod.board': '<b>E</b> pour embarquer sur le bateau de Šibenik',
    'brod.boardTouch': 'touchez pour embarquer sur le bateau de Šibenik',
    'brod.arrived': 'Šibenik. Il est à quai — attention à la marche.',
    'brod.callAway': 'on largue · Jadrija par l’arrière',
    'brod.callLight': 'phare de Rt Jadrija, à bâbord',
    'brod.callNikola': 'forteresse Saint-Nicolas, à tribord',
    'brod.callChannel': 'canal Saint-Antoine',
    'brod.callNarrows': 'le goulet · karst des deux bords',
    'brod.callSpilja': 'grotte Saint-Antoine, dans la falaise à bâbord',
    'brod.callTown': 'Šibenik · Saint-Michel sur le rocher',
    'brod.callBerth': 'accostage',
    'toast.onTheBoat': 'À bord. Il partira quand il partira ; il n’y a qu’à regarder.',
    'toast.overTheSide': 'Par-dessus bord. Il ne reviendra pas vous chercher.',
    'toast.ashoreSibenik': 'À terre à Šibenik, sous la cathédrale.',
    'toast.noQuay': 'Pas de quai où débarquer ici.',
    ...
    'body.on': 'Vue de dos. Reste immobile et elle tourne autour de toi. <b>B</b> pour revenir dans tes yeux.',
    'body.off': 'De retour dans tes yeux.',
    'chg.changed': 'Changée. <b>B</b> pour voir.',
    'chg.dressed': 'Rhabillée.',
    ...
    'clip.rec': 'rec',
    'clip.rec.full': 'plein',
    'clip.keep': 'L pour garder',
    'clip.on': 'Ça tourne. L arrête et garde.',
    'clip.saved': '%s secondes gardées · %m Mo, dans vos téléchargements.',
    'clip.empty': 'Rien d\'enregistré — laissez-lui une seconde la prochaine fois.',
    'clip.cannot': 'Ce navigateur n\'enregistre pas le canevas.',
    'clip.full': 'Arrêté à %s minutes. L garde toujours ce que vous avez.',
