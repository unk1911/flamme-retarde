...
# Balkanika. The only female voice on the account labelled `language: hr`, and
# the same id `BATHER_VOICE` gives `woman_old` — see the collision above, and
# `MUTTER.rate` in 80-audio.js, which is what stands between the two of them.
VOICE = 'VB7D8zswiztJjyl8LI3a'
