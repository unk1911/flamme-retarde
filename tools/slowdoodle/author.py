...
def yawn(t):
    head = curve(t, [(0.0, 0.0), (0.6, -8.0), (1.5, -14.0), (2.5, -13.0), (3.0, -4.0), (3.5, -1.0), (4.2, 0.0)])
    neck = curve(t, [(0.0, 0.0), (0.7, -6.0), (1.5, -9.0), (2.6, -8.0), (3.2, -2.0), (4.2, 0.0)])
    # 24 degrees at the peak, not 38: open that far with the head thrown back
    # it read as a howl. A yawn is wide, but it is a yawn.
    jaw = curve(t, [(0.0, 0.0), (0.5, 1.5), (1.0, 9.0), (1.55, 23.0), (2.45, 24.0), (2.85, 4.0), (3.1, 0.0), (4.2, 0.0)])
